...
# Быстрый поиск
 ...
 + [Git Bash for Windows](#git-bash-for-windows)
   ...
   + [Установка и настройка `Git SCM`](#установка-и-настройка-git-scm)
   + [Смена основной кодировки системы](#смена-основной-кодировки-системы)
