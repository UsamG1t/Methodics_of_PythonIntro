Данная глава — вводная, она несёт некоторый ознакомительный характер для погружения слушателя в контекст жизни языка программирования.

# Быстрый поиск

 + [История Python](#история-python)
 + [Python как ЯП](#python-как-яп)
 + [Применимость Python](#применимость-python)
