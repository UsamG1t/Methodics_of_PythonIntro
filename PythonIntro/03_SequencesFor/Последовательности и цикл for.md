В данной главе мы рассмотрим отдельный класс объектов — _последовательности_. Также обсудим работу цикла for в контексте последовательностей.

# Быстрый поиск

 + [Операции над объектами как совокупность методов](#операции-над-объектами-как-совокупность-методов)
 + [Цикл for](#цикл-for)
 + [Последовательности](#последовательности)
   + [Непосредственно, операции над последовательностями](#непосредственно,-операции-над-последовательностями)
   + [Последовательности внутри](#последовательности-внутри)
   + [Списки в секционировании, сложность модификации](#списки-в-секционировании,-сложность-модификации)
   + [Возможности списков](#возможности-списков)
 + [Дополнительные особенности последовательностей](#дополнительные-особенности-последовательностей)

---

# Операции над объектами как совокупность методов

Перед тем, как непосредственно начать разбираться с циклом for и последовательностями, необходимо немного забежать вперёд и разобраться, что из себя представляют объекты в Python. Все объекты в Python представляют некоторые экземпляры соответствующих классов-типов этих объектов. Как и у любого класса, у класса в Python есть _атрибуты_: _поля_ — атрибуты-значения — и _методы_ — атрибуты-функции.
