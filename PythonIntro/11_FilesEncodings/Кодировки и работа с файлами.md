...
Для начала Перед разговором о теме лекции поговорит о _контекстном менеджере_ — виде классов в Python, для которого из-за его популярности сделали отдельных формат обработки.
