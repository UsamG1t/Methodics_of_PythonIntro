В данной главе мы рассмотрим основные состовляющие объектно-ориентированного программирования и изучим их реализацию в Python.

# Быстрый поиск

 + [Лирическое отступление](#лирическое-отступление)
 + [Составляющие ООП в Python](#составляющие-ооп-в-python)
 + [Объекты, классы, экземпляры](#объекты,-классы,-экземпляры)
